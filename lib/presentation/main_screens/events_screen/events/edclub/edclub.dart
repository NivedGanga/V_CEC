...
import 'package:v_cec_firebse1/presentation/main_screens/events_screen/events/edclub/addeventedclub.dart';
import 'package:v_cec_firebse1/core/constants/constants.dart';

class edclub extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
                ...
                children: [
                  ...
                  CircleAvatar(
                    child: CircleAvatar(
                        ...
                        child: Image(image: AssetImage(forumlogos[11]))),
          ...
          actions: [
            (email == 'proddecapp@gmail.com' || email == 'edclub@ceconline.edu')
                ? Center(
                    child: ClipRRect(
