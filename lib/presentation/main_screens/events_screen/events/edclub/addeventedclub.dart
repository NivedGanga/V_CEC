import 'dart:io';
import 'package:v_cec_firebse1/presentation/main_screens/events_screen/events/edclub/Event_Service_edclub.dart';
import 'package:flutter/material.dart';
import 'package:image_picker/image_picker.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_storage/firebase_storage.dart';

class addeventedclub extends StatefulWidget {
  const addeventedclub({super.key});

  @override
  State<addeventedclub> createState() => _addeventedclubState();
}
...
EventServiceedclub eventService = EventServiceedclub();
...
class _addeventedclubState extends State<addeventedclub> {
  File? _image;
  var size;
  void countDocuments() async {
    QuerySnapshot doc =
        await FirebaseFirestore.instance.collection('eEdclub').get();
  ...
  validateAndUpload() {
    ...
    if (_image != null) {
      ...
      UploadTask task =
          storage.child('V-CEC_2.0.0/EDCLUB/$picture').putFile(_image!);
