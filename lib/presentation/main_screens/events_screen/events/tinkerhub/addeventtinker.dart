...
import 'dart:io';
import 'Event_Service_tinker.dart';
import 'package:flutter/material.dart';
import 'package:image_picker/image_picker.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_storage/firebase_storage.dart';

class addeventtinker extends StatefulWidget {
  const addeventtinker({super.key});

  @override
  State<addeventtinker> createState() => _addeventtinkerState();
}

var size;

EventServicetinker eventService = EventServicetinker();
...
class _addeventtinkerState extends State<addeventtinker> {
  File? _image;

  void countDocuments() async {
    QuerySnapshot doc =
        await FirebaseFirestore.instance.collection('etinkerhub').get();
  ...
  validateAndUpload() {
    ...
    if (_image != null) {
      ...
      UploadTask task =
          storage.child('V-CEC_2.0.0/TINKERHUB/$picture').putFile(_image!);
