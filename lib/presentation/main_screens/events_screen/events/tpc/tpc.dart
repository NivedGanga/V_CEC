...
import 'package:v_cec_firebse1/presentation/main_screens/events_screen/events/tpc/addeventtpc.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
            ...
            child: SizedBox(
              ...
              child: Row(
                ...
                children: [
                  ...
                  //     radius: 25,
                  //     backgroundImage: AssetImage(forumlogos[6])),
                  // SizedBox(
          ...
          actions: [
            (email == 'proddecapp@gmail.com' || email == 'tpc@ceconline.edu')
                ? Center(
                    child: ClipRRect(
