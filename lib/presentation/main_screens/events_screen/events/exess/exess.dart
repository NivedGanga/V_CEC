...
import 'package:v_cec_firebse1/presentation/main_screens/events_screen/events/exess/addeventexess.dart';
import 'package:v_cec_firebse1/core/constants/constants.dart';

class exess extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
          ...
          actions: [
            (email == 'proddecapp@gmail.com' || email == 'exess@ceconline.edu')
                ? Center(
                    child: ClipRRect(
