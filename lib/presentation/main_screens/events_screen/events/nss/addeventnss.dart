import 'dart:io';
import 'Event_Service_nss.dart';
import 'package:flutter/material.dart';
import 'package:image_picker/image_picker.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_storage/firebase_storage.dart';

class addeventnss extends StatefulWidget {
  const addeventnss({super.key});

  @override
  State<addeventnss> createState() => _addeventprodState();
}

var size;

EventServicenss eventService = EventServicenss();
...
class _addeventprodState extends State<addeventnss> {
  File? _image;

  void countDocuments() async {
    QuerySnapshot doc =
        await FirebaseFirestore.instance.collection('eNss').get();
  ...
  validateAndUpload() {
    ...
    if (_image != null) {
      ...
      UploadTask task =
          storage.child('V-CEC_2.0.0/NSS/$picture').putFile(_image!);
