...
import 'package:v_cec_firebse1/presentation/main_screens/events_screen/events/nss/addeventnss.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
              ...
              child: Row(
                ...
                children: [
                  ...
                  CircleAvatar(
                      ...
                      radius: 25,
                      backgroundImage: AssetImage(forumlogos[4])),
                  SizedBox(
          ...
          actions: [
            (email == 'proddecapp@gmail.com' || email == 'nss@ceconline.edu')
                ? Center(
                    child: ClipRRect(
