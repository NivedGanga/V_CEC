...
import 'package:v_cec_firebse1/presentation/main_screens/events_screen/events/foces/addeventfoces.dart';
import 'package:v_cec_firebse1/core/constants/constants.dart';
//import 'package:size_config/size_config.dart';

class Foces extends StatelessWidget {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
            ...
            child: SizedBox(
              ...
              child: Row(
                ...
                children: [
                  ...
                  CircleAvatar(
                    child: Image(image: AssetImage(forumlogos[9])),
          ...
          actions: [
            (email == 'proddecapp@gmail.com' || email == 'foces@ceconline.edu')
                ? Center(
                    child: ClipRRect(
