import 'dart:io';
import 'Event_Service_foces.dart';
import 'package:flutter/material.dart';
import 'package:image_picker/image_picker.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_storage/firebase_storage.dart';

class addeventfoces extends StatefulWidget {
  const addeventfoces({super.key});

  @override
  State<addeventfoces> createState() => _addeventfocesState();
}
...
EventServicefoces eventService = EventServicefoces();
...
class _addeventfocesState extends State<addeventfoces> {
  File? _image;

  void countDocuments() async {
    QuerySnapshot doc =
        await FirebaseFirestore.instance.collection('eFoces').get();
  ...
  validateAndUpload() {
    ...
    if (_image != null) {
      ...
      UploadTask task =
          storage.child('V-CEC_2.0.0/FOCES/$picture').putFile(_image!);
