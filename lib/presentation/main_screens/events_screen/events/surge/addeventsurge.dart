import 'dart:io';
import 'Event_Service_surge.dart';
import 'package:flutter/material.dart';
import 'package:image_picker/image_picker.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_storage/firebase_storage.dart';

class addeventsurge extends StatefulWidget {
  const addeventsurge({super.key});

  @override
  State<addeventsurge> createState() => _addeventsurgeState();
}

var size;

EventServicesurge eventService = EventServicesurge();
...
class _addeventsurgeState extends State<addeventsurge> {
  File? _image;

  void countDocuments() async {
    QuerySnapshot doc =
        await FirebaseFirestore.instance.collection('eSurge').get();
  ...
  validateAndUpload() {
    ...
    if (_image != null) {
      ...
      UploadTask task =
          storage.child('V-CEC_2.0.0/SURGE/$picture').putFile(_image!);
