import 'dart:io';
import 'package:v_cec_firebse1/presentation/main_screens/events_screen/events/mediacell/Event_Service_mediacell.dart';
import 'package:flutter/material.dart';
import 'package:image_picker/image_picker.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_storage/firebase_storage.dart';

class addeventmediacell extends StatefulWidget {
  const addeventmediacell({super.key});

  @override
  State<addeventmediacell> createState() => _addeventmediacellState();
}

EventServicemediacell eventService = EventServicemediacell();
...
class _addeventmediacellState extends State<addeventmediacell> {
  File? _image;
  var size;
  void countDocuments() async {
    QuerySnapshot doc =
        await FirebaseFirestore.instance.collection('eMediacell').get();
  ...
  validateAndUpload() {
    ...
    if (_image != null) {
      ...
      UploadTask task =
          storage.child('V-CEC_2.0.0/MEDIACELL/$picture').putFile(_image!);
