...
import 'package:v_cec_firebse1/presentation/main_screens/events_screen/events/arc/addeventarc.dart';
      ...
      appBar: AppBar(
            ...
            child: SizedBox(
              ...
              child: Row(
                ...
                children: [
                  ...
                  CircleAvatar(
                    child: Image(image: AssetImage(forumlogos[7])),
          ...
          actions: [
            (email == 'proddecapp@gmail.com' ||
                    email == 'alumnicell@ceconline.edu')
                ? Center(
                    child: ClipRRect(
