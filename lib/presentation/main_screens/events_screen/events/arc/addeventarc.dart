import 'dart:io';
import 'package:v_cec_firebse1/presentation/main_screens/events_screen/events/arc/Event_Service_arc.dart';
import 'package:flutter/material.dart';
import 'package:image_picker/image_picker.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_storage/firebase_storage.dart';

class addeventarc extends StatefulWidget {
  const addeventarc({super.key});

  @override
  State<addeventarc> createState() => _addeventarcState();
}
...
EventServicearc eventService = EventServicearc();
...
class _addeventarcState extends State<addeventarc> {
  File? _image;
  var size;
  void countDocuments() async {
    QuerySnapshot doc =
        await FirebaseFirestore.instance.collection('eArc').get();
  ...
  validateAndUpload() {
    ...
    if (_image != null) {
      ...
      UploadTask task =
          storage.child('V-CEC_2.0.0/ARC/$picture').putFile(_image!);
