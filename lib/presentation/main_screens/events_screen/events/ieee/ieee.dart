...
import 'package:v_cec_firebse1/presentation/main_screens/events_screen/events/ieee/addeventieee.dart';
...
// import 'package:v_cec_firebse1/events/detailed.dart';
// import 'package:v_cec_firebse1/functions.dart';
// import 'package:v_cec_firebse1/home.dart';
// import 'package:v_cec_firebse1/namearrays.dart';
...
//           headerSliverBuilder: (context, aa) => [SliverAppBar()],
//           body: Column(
//             children: [
//               SizedBox(
//                 height: 70,
...
//                     children: [
                      ...
                      //     radius: 30,
                      //     backgroundImage: AssetImage(forumlogos[1])),
//                       Text("IEEE",
//                           style: TextStyle(
//                             fontFamily: 'Ubuntu',
//                             fontWeight: FontWeight.w700,
//                             color: Colors.black,
//                             fontSize:
//                                 MediaQuery.of(context).size.height * .0550,
//                           ))
//                     ],
//                   ),
//                 )),
...
//                   child: StreamBuilder<QuerySnapshot>(
//                 stream:
//                     FirebaseFirestore.instance.collection('eIedc').snapshots(),
//                 builder: (context, snapshot) {
//                   if (!snapshot.hasData) {
...
//                                   Navigator.of(context)
//                                       .push(MaterialPageRoute(builder: (ctx) {
//                                     return detailed(event: eventpic);
//                                   }));
//                                 },
//                                 title: Row(
//                                   children: [
...
//                                         children: [
//                                           Text(
//                                             "sdfghjkljhgfdsasdfghjklkjhgfdsasdfghj",
//                                             textAlign: TextAlign.center,
//                                           ),
//                                           SizedBox(
//                                             height: MediaQuery.of(context)
