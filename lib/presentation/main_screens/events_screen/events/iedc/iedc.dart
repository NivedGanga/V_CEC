...
import 'package:v_cec_firebse1/presentation/main_screens/events_screen/events/iedc/addeventiedc.dart';
import 'package:v_cec_firebse1/core/constants/constants.dart';
//import 'package:size_config/size_config.dart';

class Iedc extends StatelessWidget {
  @override
      ...
      appBar: AppBar(
                ...
                children: [
                  ...
                  CircleAvatar(
                    child: CircleAvatar(
                      ...
                      child: Image(
                        image: AssetImage(forumlogos[2]),
                        fit: BoxFit.contain,
                      ),
                    ), //Image(image: AssetImage(forumlogos[2])),
                    backgroundColor: const Color.fromARGB(255, 255, 255, 255),
                    radius: 25,
                  ),
                  SizedBox(
          ...
          actions: [
            (email == 'proddecapp@gmail.com' ||
                    email == 'Iedc_bootcamp@ceconline.edu')
                ? Center(
                    child: ClipRRect(
