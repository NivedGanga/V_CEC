import 'dart:io';
import 'package:v_cec_firebse1/presentation/main_screens/events_screen/events/ncc/Event_Service_ncc.dart';
import 'package:flutter/material.dart';
import 'package:image_picker/image_picker.dart';
import 'package:cloud_firestore/cloud_firestore.dart';
import 'package:firebase_storage/firebase_storage.dart';

class addeventncc extends StatefulWidget {
  const addeventncc({super.key});

  @override
  State<addeventncc> createState() => _addeventnccState();
}

EventServicencc eventService = EventServicencc();
...
class _addeventnccState extends State<addeventncc> {
  File? _image;
  var size;
  void countDocuments() async {
    QuerySnapshot doc =
        await FirebaseFirestore.instance.collection('eNcc').get();
  ...
  validateAndUpload() {
    ...
    if (_image != null) {
      ...
      UploadTask task =
          storage.child('V-CEC_2.0.0/NCC/$picture').putFile(_image!);
