...
ValueNotifier<bool> otpsendNotifier = ValueNotifier(false);
...
class _Signup_mailState extends State<Signup_mail> {
    ...
    return Scaffold(
      ...
      children: [
        ...
        ValueListenableBuilder(
            valueListenable: otpsendNotifier,
  ...
  void checklogin(BuildContext ctx) async {
    ...
    if (mail == null || mail == '') {
      ...
      otpsendNotifier.value = true;
      otpsendNotifier.notifyListeners();
      randomNumber = await sendOTP(emailcontroller.text);
      otpsendNotifier.value = false;
      otpsendNotifier.notifyListeners();
      Navigator.push(
